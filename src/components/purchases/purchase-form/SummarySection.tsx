        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("newPurchase.fields.subtotal")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("newPurchase.fields.salesTax")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      min="0"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("newPurchase.fields.salesTaxAmount")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("newPurchase.fields.discount")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      min="0"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("newPurchase.fields.discountAmount")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      disabled
