...
export const TaxEditForm: React.FC<TaxEditFormProps> = ({ tax, onCancel }) => {
  const t = useTranslations("SalesTax");
  const { updateTax, isLoading } = useTaxStore();
  ...
  const onSubmit = async (data: TaxFormValues) => {
    ...
    try {
      ...
      if (response.error) {
        toast({
          title: "Error",
          description: "Failed to update tax. Please try again.",
          variant: "destructive",
        });
      } else {
        toast({
                    ...
                    <FormControl>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="ALL_PRODUCTS" id="edit_all_products" />
                          <FormLabel htmlFor="edit_all_products">
                            {t("form.allProducts")}
                          </FormLabel>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            ...
                            id="edit_specific_products"
                          />
                          <FormLabel htmlFor="edit_specific_products">
