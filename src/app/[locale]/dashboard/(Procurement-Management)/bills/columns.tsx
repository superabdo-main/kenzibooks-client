...
export const createColumns = (
  ...
  const ActionsCell = ({ row }: { row: any }) => {
    const bill = row.original as PurchaseType;
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link href={`/dashboard/bills/process-payment?id=${bill.id}`}>
                <CreditCard className="mr-2 h-4 w-4" />
                {t("columns.processPayment")}
              </Link>
            </DropdownMenuItem>
            <DropdownMenuItem asChild>
              <Link href={`/dashboard/bills/edit-bill?id=${bill.id}`}>
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span>{bill.supplier.email}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">
                          {t("infoDrawer.terms")}
                        </span>
                        <span>{getTermsLabel(bill.paymentTerm)}</span>
                      </div>
                    </div>
                  </div>
                  <Separator />
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span>
                          {formatDate(bill.expectedShipmentDate)}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-4">
                      <div>
                        ...
                        <p>
                          {bill.address.billingStreet}
                          <br />
                          {bill.address.billingCity},{" "}
                          {bill.address.billingState}{" "}
                          {bill.address.billingZipPostalCode}
                          <br />
                          {bill.address.billingCountry}
                        </p>
                      </div>
                      <div>
                        <h4 className="font-medium">
                        ...
                        <p>
                          {bill.address.shippingStreet}
                          <br />
                          {bill.address.shippingCity},{" "}
                          {bill.address.shippingState}{" "}
                          {bill.address.shippingZipPostalCode}
                          <br />
                          {bill.address.shippingCountry}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span>{formatCurrency(bill.salesTaxes)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">
