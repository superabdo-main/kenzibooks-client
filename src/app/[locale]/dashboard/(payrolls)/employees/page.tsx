...
const EmployeesPage = () => {
  ...
  const columns = createColumns(t, handleDeleteEmployee);
      ...
      <Card className="overflow-hidden border-border bg-card">
        <CardHeader className="bg-muted/30 py-5 border-b border-border flex w-full justify-between flex-row">
          ...
          <div>
            <Button
              ...
              asChild
            >
              <Link href={`/dashboard/employees/create-employee`}>
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            //   searchColumn="name"
              //   onExportPDF={() => exportEmployeesToPDF(employees || [], t)}
              //   onExportExcel={() => exportEmployeesToExcel(employees || [], t)}
              //   onExportCSV={() => exportEmployeesToCSV(employees || [], t)}
            />
          )}
        </CardContent>
      </Card>
