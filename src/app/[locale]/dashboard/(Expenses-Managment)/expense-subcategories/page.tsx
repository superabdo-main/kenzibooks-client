...
import { useExpenseSubCategories } from "@/features/expenses/hooks/useSubCategories";
...
import ExpenseSubCategoryForm from "@/features/expenses/forms/subcategories/create-form";
...
const ExpenseSubCategory = () => {
  ...
  const { expenseSubCategories, isLoading, mutate } = useExpenseSubCategories();
  ...
  const columns = createColumns(t, handleDeleteSubCategory);
    ...
    <div className="container mx-auto">
      <Dialog open={createDialog} onOpenChange={setCreateDialog}>
        <DialogContent className="sm:max-w-[600px]">
          ...
          <div className="mt-4">
            <ExpenseSubCategoryForm onCancel={() => setCreateDialog(false)} />
          </div>
        </DialogContent>
      </Dialog>
