...
import { useExpenseCategories } from "@/features/expenses/hooks/useCategories";
...
import ExpenseCategoryForm from "@/features/expenses/forms/categories/create-form";
...
const ExpenseCategory = () => {
  ...
  const columns = createColumns(t, handleDeleteCategory);
    ...
    <div className="container mx-auto">
      <Dialog open={createDialog} onOpenChange={setCreateDialog}>
        <DialogContent className="sm:max-w-[600px]">
          ...
          <div className="mt-4">
            <ExpenseCategoryForm onCancel={() => setCreateDialog(false)} />
          </div>
        </DialogContent>
      </Dialog>
