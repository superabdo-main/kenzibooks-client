...
const SuppliersPage = () => {
  ...
  const columns = createColumns(t, handleDeleteSupplier);
        ...
        <CardHeader className="bg-muted/30 py-5 border-b border-border flex w-full justify-between flex-row">
          ...
          <div>
            <Button
              ...
              asChild
            >
              <Link href={`/dashboard/suppliers/new-supplier`}>
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <DataTable
              ...
              onExportPDF={() => exportSuppliersToPDF(suppliers || [], t)}
              onExportExcel={() => exportSuppliersToExcel(suppliers || [], t)}
